...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.sqlite_malha.driver' => 'string',
            'database.connections.sqlite_malha.url' => 'NULL',
            'database.connections.sqlite_malha.database' => 'string',
            'database.connections.sqlite_malha.prefix' => 'string',
            'database.connections.sqlite_malha.foreign_key_constraints' => 'boolean',
            'database.connections.sqlite_malha.busy_timeout' => 'integer',
            'database.connections.sqlite_malha.journal_mode' => 'string',
            'database.connections.sqlite_malha.synchronous' => 'string',
            'database.connections.sqlite_malha.transaction_mode' => 'string',
            ...
            'filesystems.links./home/henrique_1/Documents/OpenAir-Metrics/public/storage' => 'string',
...
'database.connections.sqlsrv.password','database.connections.sqlsrv.charset','database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.sqlite_malha.driver',
'database.connections.sqlite_malha.url','database.connections.sqlite_malha.database','database.connections.sqlite_malha.prefix','database.connections.sqlite_malha.foreign_key_constraints','database.connections.sqlite_malha.busy_timeout',
'database.connections.sqlite_malha.journal_mode','database.connections.sqlite_malha.synchronous','database.connections.sqlite_malha.transaction_mode','database.migrations.table','database.migrations.update_date_on_publish',
...
'filesystems.disks.s3.report','filesystems.links./home/henrique_1/Documents/OpenAir-Metrics/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'session.partitioned','session.serialization','blade-heroicons.prefix','blade-heroicons.fallback','blade-heroicons.class',
'blade-heroicons.attributes','blade-icons.sets','blade-icons.class','blade-icons.attributes','blade-icons.fallback',
'blade-icons.components.disabled','blade-icons.components.default','boost.enabled','boost.browser_logs_watcher','boost.executable_paths.php',
...
'boost.browser-logs','sanctum.csrf-cookie','api.estados','api.estados.cidades',
'api.cidades.por-uf','api.cidades.bairros','api.estacoes.coordenadas','api.geocoding.reverse','api.estacoes.calcular-malha',
'api.instalacoes.vincular-mac','api.patrimonios.disponiveis','api.dashboard.graficos',
'login','dashboard','estacoes.index','estacoes.create',
'estacoes.store','estacoes.planejar','estacoes.salvar-malha','patrimonios.index','patrimonios.create',
'patrimonios.store','patrimonios.store-batch','patrimonios.destroy','instalacoes.index','instalacoes.show',
'logout','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'auth.login','components.layouts.app','components.sidebar','dashboard','estacoes.create',
'estacoes.index','estacoes.planejar','home','instalacoes.index','instalacoes.show',
'patrimonios.create','patrimonios.index','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
